...
<?php echo $this->Form->create('FieldForm');?>
	<fieldset>
 		<legend><?php printf(__('Edit %s', true), __('Field Form', true)); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('FieldForm.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('FieldForm.id'))); ?></li>
