...
//                 'vehicle_radicacion_bsas' => array('label' => 'Radicacion en Provincia de Buenos Aires', 'value' => $this->getDatafromField('Vehicle','')),
                 ...
                 'vehicle_modeloanio' => array('label' => 'Mod. Año', 'value' => date('y', strtotime($this->data['Vehicle']['adquisition_date'])) ),
                 'vehicle_type' => array('label' => 'Tipo', 'value' => ''),
                 'vehicle_use' => array('label' => 'Uso', 'value' => ''),
                 'vehicle_peso' => array('label' => 'Peso', 'value' => ''),
                 'vehicle_carga_maxima' => array('label' => 'Carga Máxima', 'value' => ''),
                 'vehicle_combustible' => array('label' => 'Combustible', 'value' => ''),
                 'vehicle_nac' => array('label' => 'NAC', 'value' => ''),
